...
const LensManagement = () => {
    ...
    const [FilterSearch, filteredData] = useFilterSearch(patients, ["name", "email", "mobile", "address"]); // Update fields here
                            ...
                            <table className="w-full text-sm text-left rtl:text-right text-gray-900 dark:text-gray-900">
                                <thead className="bg-gray-200">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3">Consultation Date</th>
                                        <th scope="col" className="px-6 py-3">Consultation Time</th>
                                ...
                                <tbody>
                                    {filteredData.map((patient, index) => (
                                        <tr key={index} className="bg-white dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4">{formatDateToLong(patient.lensConsultation.consultationDate)}</td>
                                            <td className="px-6 py-4">{formatTimeToAMPM(patient.lensConsultation.consultationTime)}</td>
                                            <td className="px-6 py-4">
                                                <button
