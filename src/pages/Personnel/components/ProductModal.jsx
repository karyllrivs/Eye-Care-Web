...
const ProductModal = ({ handleCloseModal, isModalVisible, selectedProduct }) => {
    ...
    useMemo(() => {
        if (selectedProduct._id) {
            // Ensure all fields are being set correctly, including brand
            setFormFields({
                ...emptyFields, // Start with empty fields to avoid any undefined values
                ...selectedProduct,
            });
        } else {
    ...
    const {
        ...
        price,
        stock,
        brand, // Add brand from formFields
    } = formFields;
            ...
            <form className="bg-white p-8 rounded-lg w-1/2 max-h-[90vh] overflow-y-auto" onSubmit={handleSubmit}>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <select
                                name="brand"
                                value={brand} // Ensure the brand is set correctly
                                onChange={handleChange}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2"
                            >
                    ...
                    <div className="flex-1">
                        <label className="block text-sm font-semibold text-gray-700">Thumbnails</label>
                        <input
                            type="file"
                            onChange={loadImage}
                            accept="image/*"
                ...
                <div className="mt-6 flex justify-end">
                    ...
                    <button
                        ...
                        className="text-white bg-gray-400 hover:bg-gray-500 px-9 py-2 rounded ml-2"
                    >
                        Close
                    </button>
                </div>
